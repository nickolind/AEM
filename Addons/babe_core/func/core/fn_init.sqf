...
babe_core_keyhandlersaver = (findDisplay 46) displayaddEventHandler ["KeyDown","if !(babe_core_keyhandler) then {(findDisplay 46) displayRemoveEventHandler ['KeyDown', babe_core_keyhandlersaver];call babe_core_fnc_addkeyhandler;}"];
